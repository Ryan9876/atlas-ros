...
def test_repository_contract_catalog_compiles() -> None:
    ...
    assert len(registry.contracts) == 46
    ...
    assert registry.require("atlas.clarification-analysis").writer == "1.0"
    assert registry.require("atlas.clarification-resolution").writer == "1.0"
