#!/usr/bin/env python3
"""Validate the unapplied additive v8.0.0 Notion migration against a schema fixture."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--migration",
        type=Path,
        default=Path("release/v800-notion-schema-migration.yaml"),
    )
    parser.add_argument(
        "--fixture",
        type=Path,
        default=Path("release/v800-notion-schema-fixture.json"),
    )
