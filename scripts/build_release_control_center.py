...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the read-only Atlas ROS Release Control Center")
    ...
    center = ReleaseControlCenter(active_release=args.active_release, rollback_release=args.rollback_release)
